...
/// </summary>
public sealed partial class CurrentMediaInformationWindowViewModel : WindowViewModel, IApplicationResourceAware
{
    ...
    {
        Title = this.GetLocalizedString("CurrentMediaInformationWindow/Title");
    }
}